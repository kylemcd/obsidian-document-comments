...
- Comment text can now be selected and copied — in the margin, the comments sidebar, and Reading view. Drag, double-click and triple-click select as they do anywhere else, and a click that ends a selection no longer opens the card ([#80](https://github.com/kylemcd/obsidian-document-comments/issues/80)).
