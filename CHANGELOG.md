...
- Added an **Allow empty comments** setting. An empty comment now saves a highlight without a comment card or sidebar entry ([#52](https://github.com/kylemcd/obsidian-document-comments/issues/52)).
