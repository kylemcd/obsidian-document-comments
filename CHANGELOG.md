...
- Comment text can now be selected and copied — in the margin, the comments sidebar, and Reading view. Dragging across a card's text selects it without opening the card, and a plain click still opens it ([#80](https://github.com/kylemcd/obsidian-document-comments/issues/80)).
